...
#' @details This program applies the reverse sweep operator as defined in (Dempster 1969). The code was originally written for the ISR3 package which is not available on CRAN anymore.
#' @examples
#' set.seed(100)
